...
from sqlalchemy.orm import sessionmaker, declarative_base  # Cambiado aquí
...
Base = declarative_base()  # No hay cambios aquí
...
def get_taxis():
    ...
    try:
        ...
        session.close()  # Cerrar la sesión después de su uso
